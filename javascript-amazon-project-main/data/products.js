...
// });
// console.log(product1); JUST AN EXAMPLE
...
// so .map creates a new array and when return from the inner fn i.e. (productDetails)=>{} then at that time we need to return something and that will be a class in the map's new array so map the object array or convert the obj array to class array
